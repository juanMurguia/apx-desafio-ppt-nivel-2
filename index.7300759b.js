var e=globalThis,t={},n={},i=e.parcelRequire9acc;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in n){var i=n[e];delete n[e];var s={id:e,exports:{}};return t[e]=s,i.call(s.exports,s,s.exports),s.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){n[e]=t},e.parcelRequire9acc=i),(0,i.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>n,set:e=>n=e,enumerable:!0,configurable:!0});var n,i=new Map;n=function(e,t){for(var n=0;n<t.length-1;n+=2)i.set(t[n],{baseUrl:e,path:t[n+1]})}}),i("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["dZpbI","index.7300759b.js","3tOKg","perdiste.dcc11aeb.png","7spTd","ganaste.ab8c5652.png","l7cZy","Papel.a18e2c61.png","j9E4C","Piedra.083177db.png","hWexY","Tijera.a063bb16.png","1etes","img-explosion1.eed10714.jpg"]')),customElements.define("custom-button",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.innerHTML=`
    ...
    `;let o=t.querySelector(".papel"),a=t.querySelector(".piedra"),c=t.querySelector(".tijeras");o?.addEventListener("click",()=>{clearTimeout(p),m="papel",setTimeout(()=>{e.goTo("/pelea")},1e3)}),a?.addEventListener("click",()=>{clearTimeout(p),m="piedra",setTimeout(()=>{e.goTo("/pelea")},1e3)}),c?.addEventListener("click",()=>{clearTimeout(p),m="tijeras",setTimeout(()=>{e.goTo("/pelea")},1e3)});let p=setTimeout(()=>{e.goTo("/instructions")},5e3);return t}},{path:/\/instructions/,component:function(e){let t=document.createElement("div");t.className="init-instructions",t.innerHTML=`
    ...
    `;let n=t.querySelector("button-volver-jugar");return n?.addEventListener("click",()=>{e.goTo("/instructions")}),t}},{path:/\/pelea/,component:function(e){let t=document.createElement("div");t.className="init-pelea";let n=new URL(r),i=new URL(l),s=new URL(d),o=new URL(h),c=a.getState(),p=m;a.computerPlay(),"tijeras"==p?(a.setMove("tijeras"),t.innerHTML=`
        ...
        `):"piedra"==p&&(a.setMove("piedra"),t.innerHTML=`
            ...
            `),a.whoWins(c.currentGame.myPlay,c.currentGame.computerPlay);let u=c.currentGame.resultado;return a.countPoints(u),a.getHistory(),setTimeout(()=>{"ganaste"==u?e.goTo("/resultadoGanaste"):"perdiste"==u?e.goTo("/resultadoPerdiste"):e.goTo("/juego")},3e3),t}}];!function(e){function t(e){console.log("path:",e),history.pushState({},"",e),n(e)}function n(n){if(console.log(location.host.includes("github.io")),location.host.includes("github.io")){console.log("is github pages true");let i=n.replace("/apx-desafio-ppt-nivel-2/","/");for(let n of g)if(n.path.test(i)){console.log(`Navegando a la ruta: ${i}`);let s=n.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(s)}}else for(let i of g)if(i.path.test(n)){let n=i.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(n)}console.log("El handleRoute recibio una nueva ruta",n)}"/"==location.pathname?(console.log("entra aca"),t("/inicio")):(t("/inicio"),n(location.pathname))}(document.querySelector(".root"));
//# sourceMappingURL=index.7300759b.js.map
