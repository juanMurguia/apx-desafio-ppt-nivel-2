var e=globalThis,t={},n={},i=e.parcelRequire9acc;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in n){var i=n[e];delete n[e];var s={id:e,exports:{}};return t[e]=s,i.call(s.exports,s,s.exports),s.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){n[e]=t},e.parcelRequire9acc=i),(0,i.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>n,set:e=>n=e,enumerable:!0,configurable:!0});var n,i=new Map;n=function(e,t){for(var n=0;n<t.length-1;n+=2)i.set(t[n],{baseUrl:e,path:t[n+1]})}}),i("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["dZpbI","index.d136a614.js","3tOKg","perdiste.dcc11aeb.png","7spTd","ganaste.ab8c5652.png","l7cZy","Papel.a18e2c61.png","j9E4C","Piedra.083177db.png","hWexY","Tijera.a063bb16.png","1etes","img-explosion1.eed10714.jpg"]')),customElements.define("custom-button",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.innerHTML=`
            ...
            `,this.shadow.appendChild(e),this.render()}render(){let e=document.createElement("button");e.textContent=this.textContent,e.className="root",this.shadow.appendChild(e)}});var s={};s=new URL("perdiste.dcc11aeb.png",import.meta.url).toString(),customElements.define("perdiste-el",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){let e=document.createElement("div"),t=document.createElement("img"),n=new URL(s);t.src=n,e.appendChild(t),this.shadow.appendChild(e)}});var a={};a=new URL("ganaste.ab8c5652.png",import.meta.url).toString(),customElements.define("ganaste-el",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){let e=document.createElement("div");e.className="root";let t=document.createElement("img"),n=new URL(a);t.src=n,e.appendChild(t),this.shadow.appendChild(e)}});const o={data:{currentGame:{computerPlay:"",myPlay:"",resultado:""},history:[{myPoints:0,computerPoints:0}]},listeners:[],getState(){return this.data},setState(e){for(let t of(this.data=e,this.listeners))t()},subscribe(e){this.listeners.push(e)},setMove(e){this.getState().currentGame.myPlay=e},computerPlay(){let e=this.getState(),t=["papel","piedra","tijeras"],n=t[Math.floor(Math.random()*t.length)];return e.currentGame.computerPlay=n,n},pushToHistory(e){this.getState().history.push(e)},getHistory(){let e=this.getState(),t=localStorage.getItem("history");if(t){let e=JSON.parse(t);o.data.history=e}return e.history},whoWins(e,t){let n=this.getState(),i="";return i="tijeras"==e&&"papel"==t?"ganaste":"papel"==e&&"piedra"==t?"ganaste":"piedra"==e&&"tijeras"==t?"ganaste":e==t?"empate":"perdiste",n.currentGame.resultado=i,i},countPoints(e){let t=this.getState(),n=this.getHistory();return"ganaste"==e?n[t.history.length-1].myPoints++:"perdiste"==e&&n[t.history.length-1].computerPoints++,localStorage.setItem("history",JSON.stringify(t.history)),t.history},restartGame(){let e=this.getState(),t=this.getHistory();t[e.history.length-1].myPoints=0,t[e.history.length-1].computerPoints=0,localStorage.setItem("history",JSON.stringify(e.history))}};customElements.define("score-el",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.innerHTML=`
                .root{
                    width: 259px;
                    height: 217px;
            ...
            `,t.querySelector(".timer__svg");let n=5,i=setInterval(()=>{--n<0?clearInterval(i):t.querySelector(".timer__number").textContent=n.toString()},1e3);this.shadow.appendChild(t)}});const c=new URL(r),p=new URL(l),u=new URL(d);customElements.define("computer-play",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.innerHTML=`
        .root{
            heigth: 250px;
            width: 100px;
        }
    `,this.shadow.appendChild(e),this.render()}render(){let e=o.getState().currentGame.computerPlay,t=document.createElement("div");"tijeras"===e?t.innerHTML=`
        ...
        `,this.shadow.appendChild(e),this.render()}render(){let e=document.createElement("button");e.textContent=this.textContent,e.className="root",this.shadow.appendChild(e)}});let m="";var h={};h=new URL("img-explosion1.eed10714.jpg",import.meta.url).toString();const g=[{path:/\/juego/,component:function(e){let t=document.createElement("div");t.className="init-juego";let n=new URL(r),i=new URL(l),s=new URL(d);t.innerHTML=`
    ...
    `;let a=t.querySelector(".papel"),o=t.querySelector(".piedra"),c=t.querySelector(".tijeras");a?.addEventListener("click",()=>{clearTimeout(p),m="papel",setTimeout(()=>{e.goTo("/pelea")},1e3)}),o?.addEventListener("click",()=>{clearTimeout(p),m="piedra",setTimeout(()=>{e.goTo("/pelea")},1e3)}),c?.addEventListener("click",()=>{clearTimeout(p),m="tijeras",setTimeout(()=>{e.goTo("/pelea")},1e3)});let p=setTimeout(()=>{e.goTo("/instructions")},5e3);return t}},{path:/\/instructions/,component:function(e){let t=document.createElement("div");t.className="init-instructions",t.innerHTML=`
    ...
    `;let n=t.querySelector(".init-instructions__button");n?.addEventListener("click",()=>{e.goTo("/juego")});let i=t.querySelector(".init-instructions__reset-button");return i?.addEventListener("click",()=>{o.restartGame()}),t}},{path:/\/inicio/,component:function(e){let t=document.createElement("div");t.className="init-page",t.innerHTML=`
    ...
    `;let n=t.querySelector("button-volver-jugar");return n?.addEventListener("click",()=>{e.goTo("/instructions")}),t}},{path:/\/pelea/,component:function(e){let t=document.createElement("div");t.className="init-pelea";let n=new URL(r),i=new URL(l),s=new URL(d),a=new URL(h),c=o.getState(),p=m;o.computerPlay(),"tijeras"==p?(o.setMove("tijeras"),t.innerHTML=`
        ...
        `):"papel"==p?(o.setMove("papel"),t.innerHTML=`
            <div class="init-pelea">
                <div class="init-pelea__rotada">
                    <computer-play></computer-play>
                </div>
        ...
        `):"piedra"==p&&(o.setMove("piedra"),t.innerHTML=`
            <div class="init-pelea">
                <div class="init-pelea__rotada">
                    <computer-play></computer-play>
                </div>
            ...
            `),o.whoWins(c.currentGame.myPlay,c.currentGame.computerPlay);let u=c.currentGame.resultado;return o.countPoints(u),o.getHistory(),setTimeout(()=>{"ganaste"==u?e.goTo("/resultadoGanaste"):"perdiste"==u?e.goTo("/resultadoPerdiste"):e.goTo("/juego")},3e3),t}}];!function(e){function t(e){history.pushState({},"",e),n(e)}function n(n){if(console.log(location.host.includes("github.io")),location.host.includes("github.io")){console.log("is github pages true");let i=n.replace("/apx-desafio-ppt-nivel-2/","/");for(let n of g)if(n.path.test(i)){console.log(`Navegando a la ruta: ${i}`);let s=n.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(s)}}else for(let i of g)if(i.path.test(n)){let n=i.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(n)}console.log("El handleRoute recibio una nueva ruta",n)}"/"==location.pathname?(console.log("entra aca"),t("/inicio")):n(location.pathname)}(document.querySelector(".root"));
//# sourceMappingURL=index.d136a614.js.map
